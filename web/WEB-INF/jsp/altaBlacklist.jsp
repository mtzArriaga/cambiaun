<%-- 
    Document   : altaBlacklist
    Created on : 21/03/2021, 08:57:11 AM
    Author     : PC7
--%>
...
<html>
	...
	<title>Ingresar Lista negra</title>
    ...
    <body>
        ...
        <div class="container mt-5 col-lg-5">
            <div class="card boarder-info">
                ...
                <div class="card-body">
                    <form method="POST">
                        <label>ID Blacklist: </label>
                        <input type="number" name="idBlacklist" class="form-control" required="true">
