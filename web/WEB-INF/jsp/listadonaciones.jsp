<%-- 
    ...
    Created on : 21/03/2021, 03:47:15 AM
    Author     : PC7
--%>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Monto</th>
                                <th>Fecha</th>
                                <th>Dirección donador</th>
                                <th>Dirección de factura</th>
                                <th>Cuenta bancaría</th>
                                <th>ID sucursal</th>
                            </tr>
                        </thead>
                        <tbody id="myTable">
                            <c:forEach var="dato" items="${lista}">
                                <tr>
                                    <td>${dato.idDonacion}</td>
                                    <td>${dato.nombreDonador}</td>
                                    <td>${dato.telefonoDonador}</td>
                                    <td>${dato.emailDonador}</td>
                                    <td>${dato.montoDonacion}</td>
                                    <td>${dato.fechaDonacion}</td>
                                    <td>${dato.direccionDonador}</td>
                                    <td>${dato.direccionFactura}</td>
                                    <td>${dato.cuentaBancaria}</td>
                                    <td>${dato.idsucursal}</td>
                                    <td>
                                        <a href="editarDonaciones.htm?idDonacion=${dato.idDonacion}"
                                           class="btn btn-warning">Editar</a>
                                        <a href="eliminardonaciones.htm?idDonacion=${dato.idDonacion}"
