<%-- 
    ...
    Created on : 21/03/2021, 08:20:57 AM
    Author     : PC7
--%>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Dirección del adoptante</th>
                                <th>Telefono del adoptante</th>
                                <th>Fecha de adopción</th>
                                <th>Ocupación del adoptante</th>
                                <th>ID del animal</th>                                
                            </tr>
                        </thead>
                        <tbody id="myTable">
                            <c:forEach var="dato" items="${lista}">
                                <tr>
                                    ...
                                    <td>${dato.nombreAdoptador}</td>
                                    <td>${dato.direccionAdoptador}</td>
                                    <td>${dato.telefonoAdoptador}</td>
                                    <td>${dato.fechaAdopcion}</td>
                                    <td>${dato.ocupacion}</td>
                                    <td>${dato.idanimal}</td>                                    
                                    <td>
                                        <a href="editarAdopcion.htm?idAdopcion=${dato.idAdopcion}"
                                           class="btn btn-warning">Editar</a>
                                        <a href="eliminaradopcion.htm?idAdopcion=${dato.idAdopcion}"
