<%-- 
    Document   : listasucursal
    Created on : 21/03/2021, 02:52:46 AM
    Author     : PC7
--%>
                        ...
                        <tbody id="myTable">
                            <c:forEach var="dato" items="${lista}">
                                <tr>
                                    ...
                                    <td>${dato.telefono}</td>
                                    <td>${dato.cantidadAnimales}</td>
                                    <td>${dato.cupoMaximoAnimales}</td>                                    
                                    <td>
                                        <a href="editarSucursal.htm?idSucursal=${dato.idSucursal}"
                                           class="btn btn-warning">Editar</a>
                                        <a href="eliminarsucursal.htm?idSucursal=${dato.idSucursal}"
