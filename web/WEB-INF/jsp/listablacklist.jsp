<%-- 
    Document   : listablacklist
    Created on : 21/03/2021, 09:01:03 AM
    Author     : PC7
--%>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody id="myTable">
                            <c:forEach var="dato" items="${lista}">
                                <tr>
                                    <td>${dato.idBlacklist}</td>
                                    <td>${dato.idadopcion}</td>
                                    <td>${dato.idseguimiento}</td>                                    
                                    <td>
                                        <a href="editarBlacklist.htm?idBlacklist=${dato.idBlacklist}"
                                           class="btn btn-warning">Editar</a>
                                        <a href="eliminarblacklist.htm?idBlacklist=${dato.idBlacklist}"
